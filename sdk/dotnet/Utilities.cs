...
namespace Pulumi.CatalystsquadPlatform
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/catalystsquad/pulumi-catalystsquad-platform/releases/download/v${VERSION}";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.CatalystsquadPlatform.version.txt");
    ...
    internal sealed class CatalystsquadPlatformResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public CatalystsquadPlatformResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
